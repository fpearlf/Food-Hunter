...
<html>
  ...
  <head>
    <title> Explore | Food Hunter </title>
  </head>
...
$R_namesql = "SELECT * FROM RESTAURANTS, FOOD WHERE RESTAURANTS.R_ID=FOOD.R_ID";
...
echo $R_name;
echo'</h1>';*/
if (mysqli_num_rows($R_nameresult) > 0)
{

  while($row = mysqli_fetch_assoc($R_nameresult)) {
...
<h5 class="text-info"><?php echo $row["address"];echo "--"; echo $row["nameres"];?></h5>
<img src="<?php echo $row["images_path"]; ?>" class="img-responsive">
<h5 class="text-info"><?php echo $row["name"]; ?></h5>
<h5 class="text-info"><?php echo $row["description"]; ?></h5>
<h5 class="text-danger">frs <?php echo $row["price"]; ?>/-</h5>
